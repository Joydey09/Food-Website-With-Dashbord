...
<div class="side-header">
    ...
    <h5 style="margin-top:10px;">Hello, Anisha</h5>
</div>
...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="#sizes"   onclick="showSizes()" ><i class="fa fa-th"></i> Available Item</a>
    <!-- <a href="#productsizes"   onclick="showProductSizes()" ><i class="fa fa-th-list"></i> Product Sizes</a>     -->
    <a href="#products"   onclick="showProductItems()" ><i class="fa fa-th"></i> All Foods</a>
